...
非対応の返信には付けない。「見送らせてください」が既に同じ働きをしており、重ねると謝罪が主題になって**理由が読まれなくなる**。`[ask]` への回答も同じで、聞かれて答えているだけの場面では要らない。
...
**🙇🏽‍♂️ とは別の話。** あちらは行末の 1 文字で、**本文を占めません**。散文の謝罪は冒頭に来るので、**謝罪が主題になって理由が読まれなくなる**——上の「非対応の返信には付けない」と同じ理由が、散文では常に働きます。
...
- **🙇🏽‍♂️ を非対応の返信や `[ask]` への回答にも付けること**。謝罪が主題になり、理由や答えが読まれなくなる
